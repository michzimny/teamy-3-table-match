...
TRUNCATE TABLE 2sesp._scores;
INSERT INTO 2sesp._scores (rnd,segment,tabl,room,board,declarer,contract,result,lead,score)
...
SELECT * FROM 2sesp._scores;
DELETE FROM 2sesp.scores WHERE rnd>(@day-1)*3 AND segment=@segment;
INSERT INTO 2sesp.scores SELECT * FROM 2sesp._scores;
TRUNCATE TABLE 2sesp._scores;
